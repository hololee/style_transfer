...
style_img = image_loader("/home/user01/data_ssd/LeeJongHyeok/pytorch_project/style_transfer/images/starry_night.jpg")
...
output = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                            content_img, style_img, input_img,num_steps=1500, style_weight=100000, content_weight=1)
